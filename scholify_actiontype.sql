...
INSERT INTO `actiontype` VALUES ('applied'),('bookmarked'),('documents uploaded'),('downloaded rulebook'),('follow up email'),('follow up enquiry'),('Login'),('peer review'),('re upload docs'),('Terms and conditions enquiry'),('visited sponsors website');
